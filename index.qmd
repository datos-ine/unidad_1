...
![[Artwork por \@allison_horst](https://allisonhorst.com/)](images/dibujo.png){fig-align="center"}
...
![](images/errores_advertencias.PNG){fig-align="center" width="70%"}
...
![](images/tipo_datos.JPG){fig-align="center" width="80%"}
...
![](images/objetos_R.png){fig-align="center" width="80%"}
...
```{r}
#| echo: false
tibble(Operador = c("NA", "NaN", "Inf", "-Inf", "NULL"),
       Significado = c("Not available", "Not a number", "Infinity",
                       "Infinity", "Null"),
...
Observemos que las dos ultimas salidas son idénticas, dado que muestran todas las observaciones de la variable `sexo`, aunque la solicitud sea de manera diferente.
