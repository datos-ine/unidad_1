...
![[Artwork por \@allison_horst](https://allisonhorst.com/)](images/dibujo4.png)
...
datos <- read_excel("datos/datos2.xlsx", col_types = c("numeric", "text", "numeric", "numeric", "numeric", "logical", "date")) %>% 
...
knitr::include_graphics("images/Pareto.PNG")
```
